...
Соответственно есть 3 способа запустить приложение, описанные ниже.
...
## 2.3. Запуск средствами Streamlit на локальной машине.
...
## 2.4. Использование развернутого приложения на платформе Streamlit.
Равернутое приложение доступно по [ссылке](https://dragomirskiy-ml-fastapi-tests-sentime-main-for-streamlit-vosezt.streamlit.app/).
